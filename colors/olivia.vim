...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1f1e20', '#aa2f3b', '#c6c5bf', '#e5d4aa', '#737174', '#747271', '#62605f', '#f2efed', '#505354', '#deaf9d', '#c6c5bf', '#e6ce92', '#919495', '#9a9a9d', '#a3a3a6', '#dadbd6']
  ...
  hi Comment guifg=#505354 guibg=NONE gui=italic
  hi Constant guifg=#e5d4aa guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#f2efed guibg=#aa2f3b gui=NONE cterm=NONE
